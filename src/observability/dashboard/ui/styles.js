...
/* #282 — source-linked Evidence Center */
.evidence-toolbar,.evidence-toolbar nav,.evidence-status-filters{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.evidence-toolbar{justify-content:space-between;margin-bottom:14px}.evidence-toolbar nav button,.evidence-status-filters button{border:1px solid var(--line);border-radius:999px;background:var(--panel);padding:8px 12px;color:var(--muted);font:inherit;font-weight:650;cursor:pointer}.evidence-toolbar button[aria-pressed="true"],.evidence-status-filters button[aria-pressed="true"]{border-color:var(--blue);background:var(--blue-soft);color:var(--blue)}
.evidence-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:12px}.evidence-kpis>div{display:flex;flex-direction:column;gap:3px;padding:15px;border:1px solid var(--line);border-radius:11px;background:var(--panel)}.evidence-kpis span,.evidence-kpis small{color:var(--muted)}.evidence-kpis strong{font-size:24px}.evidence-verdict{display:flex;justify-content:space-between;gap:16px;margin-bottom:14px;padding:15px 17px;border-left:4px solid var(--line-strong);border-radius:10px;background:var(--panel)}.evidence-verdict.blocked{border-color:var(--danger)}.evidence-verdict.verified{border-color:var(--success)}.evidence-verdict>div{display:flex;flex-direction:column;gap:3px}.evidence-verdict span{color:var(--muted);font-size:12px}
.evidence-matrix{display:grid;gap:1px;overflow:hidden;border:1px solid var(--line);border-radius:10px;background:var(--line)}.evidence-matrix-row{display:grid;grid-template-columns:minmax(210px,1.4fr) repeat(5,minmax(145px,1fr));background:var(--panel)}.evidence-matrix-row>div,.evidence-matrix-row>header{min-width:0;padding:12px;border-right:1px solid var(--line)}.evidence-matrix-head{font-size:11px;font-weight:750;text-transform:uppercase;color:var(--muted)}.evidence-matrix-row header{display:flex;flex-direction:column;gap:4px}.evidence-matrix-row header span{font-size:13px}.evidence-matrix-row header small{color:var(--muted)}.evidence-cell{display:flex;flex-direction:column;align-items:flex-start;gap:5px}.evidence-availability{font-size:11px;color:var(--muted)}.evidence-source{max-width:100%;padding:0;border:0;background:none;color:var(--blue);font:inherit;font-size:11px;text-align:left;overflow-wrap:anywhere;cursor:pointer}.evidence-source.static{color:var(--muted);cursor:default}.evidence-no-source{font-size:11px;color:var(--muted)}.evidence-mobile-label{display:none}.evidence-rationale-list{display:grid;gap:9px}.evidence-rationale{display:flex;justify-content:space-between;gap:12px;padding:14px;border:1px solid var(--line);border-radius:10px;background:var(--panel)}.evidence-rationale>div{display:flex;align-items:center;gap:9px}
@media(max-width:700px){.evidence-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.evidence-verdict{flex-direction:column}.evidence-matrix{border:0;background:transparent;overflow:visible}.evidence-matrix-head{display:none}.evidence-matrix-row{display:block;margin-bottom:12px;border:1px solid var(--line);border-radius:10px;overflow:hidden}.evidence-matrix-row>header{border-right:0;border-bottom:1px solid var(--line)}.evidence-matrix-row>div{display:grid;grid-template-columns:105px minmax(0,1fr);border-right:0;border-bottom:1px solid var(--line)}.evidence-mobile-label{display:block;color:var(--muted);font-size:11px;font-weight:750;text-transform:uppercase}.evidence-rationale{flex-direction:column}.evidence-rationale>div{align-items:flex-start;flex-direction:column}}
