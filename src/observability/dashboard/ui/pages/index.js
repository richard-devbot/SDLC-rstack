...
function pageBody(id) {
  const bodies = {
    ...
    'action-inbox': `
      <section class="action-inbox-summary" aria-label="Action queue summary">
        <div><span>Open</span><strong id="action-inbox-open-count">—</strong></div>
        <div><span>Blocking</span><strong id="action-inbox-blocking-count">—</strong></div>
        <div><span>Source signals</span><strong id="action-inbox-source-count">—</strong></div>
      </section>
      <nav class="action-inbox-filters" id="action-inbox-filters" aria-label="Action Inbox filters"></nav>
      <div class="panel"><div class="panel-head"><span class="panel-title">Human attention queue</span><span class="panel-note" id="action-inbox-result-count"></span></div><div class="panel-body"><div class="action-inbox-list" id="action-inbox-list"></div></div></div>
    `,
