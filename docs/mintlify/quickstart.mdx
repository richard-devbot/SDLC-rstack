...
the same for everyone. No framework installed yet? The repo's
[RStack in 5 Minutes](https://github.com/richard-devbot/SDLC-rstack/blob/main/docs/quick-start-guide.md)
walks the same journey from a bare terminal via the bridge.
